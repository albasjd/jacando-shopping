...
const ThemeSettings = () => {
  ...
  const setCurrentColor = useCurrentColor(state => state.setCurrentColor);
  const currentMode = useCurrentMode(state => state.currentMode);
  const setCurrentMode = useCurrentMode(state => state.setCurrentMode);
        ...
        <div className="flex-col border-t-1 border-color p-4 ml-4">
          ...
          <div className="mt-4">
            <input
              ...
              onChange={(evt) => setCurrentMode(evt.target.value)}
